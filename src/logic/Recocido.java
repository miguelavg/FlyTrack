...
public class Recocido {
    ...
    private List<Vuelo> vuelos;            // todos los vuelos
    private ArrayList<Vuelo> solucion;          // ruta solución
    private ArrayList<Vuelo> alterado;          // ruta alterada

    public Recocido(int kSA, double temperaturaInicial, double temperaturaFinal, double alfaSA, double alfaGrasp, double pParada, int intentos, Envio envio, List<Vuelo> vuelos, double costoAlmacen) {
        this.kSA = kSA;
    ...
    private int estadoEnergia(ArrayList<Vuelo> vuelos, Date llegada) {
        ...
        for (int i = 0; i < vuelos.size(); i++) {
            ...
            iCostoAlmacen = costoAlmacen * (double) milisec / (60 * 60000);
